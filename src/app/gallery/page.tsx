...
export default function Gallery() {
  return (
    <div className="flex flex-col w-full">
      ...
      <div
        id="gold"
        className="sticky top-0 z-10 w-full py-6 text-[#be9858] font-display text-center text-[30px] font-light bg-gray-700 shadow-md"
      >
      ...
      <div
        id="watch"
        className="sticky top-0 z-10 w-full py-6 tracking-wider text-[#be9858] font-display text-center text-[30px] font-light bg-gray-700 shadow-md"
      >
        <span>WATCH</span>
      </div>
      <ul className="flex flex-col">
