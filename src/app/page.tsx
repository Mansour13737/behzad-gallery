...
export default function Home() {
  return (
    <div className="w-full relative flex flex-col min-h-screen bg-[url('/Home1.png')] lazy bg-no-repeat bg-cover bg-center">
      ...
      <span className="text-white/90 tracking-wider absolute bottom-29 font-display text-center text-[14px] left-3 font-light">GET IN TOUCH</span>
      <ul className="flex gap-2 absolute left-3 bottom-21">
      ...
      <Button hrf="/gallery" cls='border-[0.5px] absolute border-white/80 text-white/90 bottom-15 right-15 w-fit py-2 px-10 font-display tracking-widest rounded-[3px] text-[14px] backdrop-blur-[3px]'>
        GALLERY
      </Button>
    </div>
  );
