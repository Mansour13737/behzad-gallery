...
export default function Home() {
  return (
    <div className="w-full relative flex flex-col min-h-screen bg-[url('/Home1.png')] lazy bg-no-repeat bg-cover bg-center">
      ...
      <Button hrf="/gallery" cls='border-[0.5px] absolute border-white/80 text-white/90 bottom-18 right-15 w-fit py-2 px-10 font-display tracking-widest rounded-[3px] text-[14px] backdrop-blur-[3px]'>
        GALLERY
      </Button>
    </div>
  );
