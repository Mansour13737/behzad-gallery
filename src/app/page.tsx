...
export default function Home() {
  return (
    <div className="w-full relative flex flex-col min-h-screen bg-[url('/Home1.png')] bg-no-repeat bg-cover bg-center">
      <Navbar />
      ...
      <ul className="flex gap-2 absolute left-3 bottom-16">
        <Link href={'tel:+989120687097'}>
          <Image src={'/call.svg'} width={24} height={24} alt='pic' />
        </Link>
        <Link href={"mailto:mansournosrati69@gmail.com"}>
          <Image src={'/message.svg'} width={24} height={24} alt='pic' />
        </Link>
        <Link href={'https://www.instagram.com/behbiin?igsh=MTE5bjBuYnlrb210cw=='}>
          <Image src={'/instagram.svg'} width={24} height={24} alt='pic' />
        </Link>
      </ul>
