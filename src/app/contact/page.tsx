...
export default function Contact() {
  return (
    <div className="min-h-screen relative flex flex-col bg-[url('/Home1.png')] bg-no-repeat bg-cover bg-center px-6 py-16 md:px-20 text-white font-display font-light">
      ...
      <div className="max-w-3xl mx-auto bg-black/60 backdrop-blur-md rounded-lg p-4 rounded-[8px] flex flex-col items-center shadow-lg">
        ...
        <div className="mt-12 text-left text-white/70 space-y-2 font-light text-sm self-start">
      ...
      <span className="text-[#be9858] tracking-wider absolute bottom-20 left-6 font-display text-[14px] font-light">
        GET IN TOUCH
      </span>
    </div>
  );
